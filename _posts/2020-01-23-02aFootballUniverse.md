...
The **network-process perspective** of the blog is centered in a **generative process** of *Levy flights* or *effective trajectories* from any location inside the landscape after regaining possession of the ball or in the *perimeter* or inside the landscape after a rule has been applied by the arbiter to regain possession of the ball and ends with a contralateral atomic action that direct the ball to opponent's goal. The *collection of Levy flights generated by the football team* is, with the arrow time evolution of the final *goal difference*, an important information derived by network-process analysis. 
